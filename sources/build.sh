...
#echo "Generating VFs"
#fontmake -g sources/Junction.glyphs -o variable --output-path ./fonts/variable/Junction[wght].ttf
...
fontmake -g sources/Junction.glyphs -i -o ttf --output-dir ./fonts/static/ttf/
fontmake -g sources/Junction.glyphs -i -o otf --output-dir ./fonts/static/otf/
